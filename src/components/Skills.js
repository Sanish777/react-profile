        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              >
                {/* <h6>Skills</h6> */}
                <h4>Progamming Skills I have <em>Gained</em></h4>
                              ...
                              <div class="row">
                                <div class="col-lg-6 align-self-center">
                                  <div class="left-text">
                                    ...
                                    <div class="ticks-list">
                                      <span
                                        ><i class="fa fa-check"></i> Laravel Framework (MVC and Repository Pattern  )</span
                                      >
                                      <span
                                        ><i class="fa fa-check"></i>Lumen Micro Framework</span
                                      >
                                      <span
                                        ><i class="fa fa-check"></i> Core PHP Programming</span
                                      >
                                      <span
                                        ><i class="fa fa-check"></i> PHP Programming with OOP (MVC)</span
                                      >
                                      <span
                                        ><i class="fa fa-check"></i> Build Restful API</span
                                      >
                                      <span
                                        ><i class="fa fa-check"></i>Frontend Intregation with Blade</span
                                      >
                                    </div>
                                    {/* <p>
                                ...
                                <div class="col-lg-6 align-self-center">
                                  <div class="right-image">
                                    <img
                                      src="assets/images/php-detail.jpg"
                                      alt=""
                                    />
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                <div class="col-lg-6 align-self-center">
                                  <div class="left-text">
                                    ...
                                    <div class="ticks-list">
                                    <span
                                        ><i class="fa fa-check"></i> Knowledge on ES6.</span
                                      ><br/>
                                      <span
                                        ><i class="fa fa-check"></i> React JS (Learning).</span
                                      ><br/>
                                      <span
                                        ><i class="fa fa-check"></i> Familiar with Vue Js.</span
                                      ><br/>
                                      
                                      <span
                                        ><i class="fa fa-check"></i> Worked with JSON Data.</span
                                      >
                                    </div>
                                    {/* <p>
                                      Lorem ipsum dolor sit amet, consectetur
                                ...
                                <div class="col-lg-6 align-self-center">
                                  <div class="right-image">
                                    <img
                                      src="assets/images/js-detail.png"
                                      alt=""
                                    />
                                  </div>
                                </div>
